...
public class ProgramaTerrenosTriangulares {
    ...
    public static Triangulo[] gerarTerrenos(int quantidade){
        ...
        for(int i = 0;i<terrenos.length;i++){
            int terreno = i+1;
            terrenos[i] = new Triangulo(Entrada.leiaDouble("Digite o lado A do terreno "+terreno),Entrada.leiaDouble("Digite o lado B do terreno "+terreno),Entrada.leiaDouble("Digite o lado C do terreno "+terreno));
        }
        return(terrenos);
    }
}