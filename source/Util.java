...
public class Util {
    ...
    public static double calcularMediana(int[] original) {
        int[] vetor = Arrays.copyOf(original, original.length);
        ordenarVetor(vetor);
    ...
    public static double calcularMediana2(int[] original) {
        int[] vetor = Arrays.copyOf(original, original.length);
        double mediana = 0;
        ordenarVetor(vetor);
    ...
    public static void ordenarVetor2(int[] vetor){
